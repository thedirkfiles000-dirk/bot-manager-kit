<!-- src/components/panels/DialogExamplesPanel.vue -->
<template>
  <panel-wrapper :title="title || 'Dialog Examples'" subtitle="Few-shot examples of voice/style/tone. Add as many or as few as you need; 2–4 are usually enough. Empty examples are skipped on export." :max-width="1200">
    ...
    <v-dialog v-model="editorDialog" max-width="900" persistent scrollable>
      <v-card>
        <v-card-title>
          Editing Example {{ editingIdx !== null ? editingIdx + 1 : "?" }}
        </v-card-title>
